...
void Update()
        ...
        foreach (Transform child in transform)
        {
            switch (child.gameObject.tag)
            {
                ...
                case "Elevator":
                    ...
                    break;
                case "Angle":
                    scene.AddAngle(new serialize.Angle(child.position, child.eulerAngles, child.localScale));
                    break;
                default:
                    break;
            }
    ...
    public void Load(int i)
    {
        ...
        foreach (Angle angli in scene.angles)
        {
            GameObject angle = Instantiate(Resources.Load("angle") as GameObject);
            angle.GetComponent<Transform>().localScale = angli.scale;
            angle.GetComponent<Transform>().eulerAngles = angli.rotation;
            angle.GetComponent<Transform>().position = angli.position;
            angle.GetComponent<Transform>().parent = this.GetComponent<Transform>();
            angle.tag = "Sol";
        }
